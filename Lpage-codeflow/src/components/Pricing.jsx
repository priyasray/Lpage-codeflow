    ...
    >
      <div className="max-w-7xl mx-auto">
        ...
        <div className='grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 sm:gap-8 lg:gap-6'>
          {plans.map((plan, key) => (
            <div key={key} className={`relative bg-slate-900/50 backdrop-blur-sm border rounded-xl sm:rounded-2xl p-6 sm:p-8 transition-all duration-300 overflow-visible group flex flex-col h-full
              ...
              {plan.mostPopular && (
                <div className='absolute -top-0.5 left-1/2 transform -translate-1/2 z-10'>
                  <div className='flex items-center space-x-1 px-3 sm:px-4 py-1 sm:py-1.5 bg-linear-to-b from-blue-500 to-cyan-500 rounded-full text-xs sm:text-sm shadow-lg'>
              ...
              <div className='text-center mb-6 sm:mb-8'>
                ...
                <div className='flex items-baseline justify-center '>
                  <span className='text-3xl sm:text-4xl lg:text-5xl font-semibold bg-linear-to-b from-blue-400 to-cyan-400 text-transparent bg-clip-text'>
                    ${plan.price}
                  </span>
                  <span className='text-gray-400 ml-1 sm:ml-2 text-sm sm:text-lg'>/month</span>
                </div>
              </div>
              ...
              <button className={`w-full py-2.5 sm:py-3 px-4 sm:px-6 rounded-lg transition-all duration-300 mt-auto hover:scale-102 cursor-pointer font-medium ${plan.mostPopular
        ...
        <div className='mt-8 sm:mt-12 text-center'>
          <p className='text-gray-400 '>Need a custom plan?<a href='#' className='text-blue-400 hover:text-blue-400/85'> Contact our sales team</a></p>
        </div>
      </div>
    </section >
  )
